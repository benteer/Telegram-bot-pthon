...
bot = telegram.Bot(token='7303385771:AAHlWIoWnaUsvY3DyQZkcxDBBQuLBYh5B-k') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='7303385771:AAHlWIoWnaUsvY3DyQZkcxDBBQuLBYh5B-k', use_context=True) #Replace TOKEN with your token string
dispatcher = updater.dispatcher


#hello world response
def hello(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text='Hello, This is telegram bot')
def hello2(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text='Hello, I am a s telegram bot')
...
hello_handler2 = CommandHandler('hello2', hello2)
dispatcher.add_handler(hello_handler)

dispatcher.add_handler(hello_handler2)
